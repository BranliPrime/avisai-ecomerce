              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                <div className="lg:col-span-2 xl:col-span-3">
                  ...
                  <input
                    ...
                    maxLength={100}
                    required
                    className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors ${errors.name ? "border-red-500 bg-red-50" : "border-gray-300 bg-white"
                      }`}
                  />
                  {errors.name && (
                ...
                <div className="lg:col-span-2 xl:col-span-2">
                  ...
                  <textarea
                    ...
                    rows={4}
                    maxLength={1000}
                    className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white resize-none transition-colors ${errors.description ? "border-red-500 bg-red-50" : "border-gray-300"
                      }`}
                  />
                  {errors.description && (
                    <p className="text-red-600 text-sm mt-1 flex items-center gap-1">
                ...
                <div className="xl:col-span-1">
                  ...
                  <input
                    ...
                    maxLength={20}
                    required
                    className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white transition-colors ${errors.unit ? "border-red-500 bg-red-50" : "border-gray-300"
                      }`}
                  />
                  {errors.unit && (
                    <p className="text-red-600 text-sm mt-1 flex items-center gap-1">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 lg:p-8">
              ...
              <div className="space-y-4">
                <label htmlFor="productImage" className="block">
                  <div
                    className={`border-2 border-dashed rounded-lg p-8 text-center hover:border-green-400 hover:bg-green-50 transition-colors cursor-pointer ${errors.image ? "border-red-300 bg-red-50" : "border-gray-300"
                      }`}
                  >
                    {imageLoading ? (
                      <Loading />
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 lg:p-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div>
                  ...
                  <select
                    className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white ${errors.category ? "border-red-500 bg-red-50" : "border-gray-300"
                      }`}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-4 gap-6">
                <div>
                  ...
                  <input
                    ...
                    step="1"
                    required
                    className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors ${errors.stock ? "border-red-500 bg-red-50" : "border-gray-300 bg-white"
                      }`}
                  />
                  {errors.stock && (
                    <p className="text-red-600 text-sm mt-1 flex items-center gap-1">
                ...
                <div>
                  ...
                  <input
                    ...
                    step="0.01"
                    required
                    className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors ${errors.price ? "border-red-500 bg-red-50" : "border-gray-300 bg-white"
                      }`}
                  />
                  {errors.price && (
                    <p className="text-red-600 text-sm mt-1 flex items-center gap-1">
                ...
                <div>
                  ...
                  <input
                    ...
                    step="1"
                    onChange={handleChange}
                    className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors ${errors.discount ? "border-red-500 bg-red-50" : "border-gray-300 bg-white"
                      }`}
                  />
                  {errors.discount && (
                    <p className="text-red-600 text-sm mt-1 flex items-center gap-1">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 lg:p-8">
              <div className="flex flex-col sm:flex-row gap-4 justify-between">
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 border border-gray-400 text-gray-700 rounded-lg hover:bg-green-500 font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
